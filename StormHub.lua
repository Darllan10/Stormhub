...
local Window = Libary:MakeWindow({
    Title = "Storm hub | Brookhaven RP ",
    SubTitle = "by: darllan",
    LoadText = "Carregando Storm Hub",
    Flags = "StormHub_Broookhaven"
})
...
InfoTab:AddParagraph({ "Owner / Developer:", "Darllan." })
InfoTab:AddParagraph({ "Colaborações:", Ninguém" })
InfoTab:AddParagraph({ "Você está usando:", "storm Hub Brookhaven " })
